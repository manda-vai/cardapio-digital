...
interface PublicMenuPageClientProps {
  store: Store;
  categories: Category[];
  items: MenuItem[];
}
        ...
        <div className="mb-6">
          ...
          <div className="flex flex-wrap gap-3 mt-3">
            ...
            {store.delivery_min_order > 0 && (
              <Badge variant="neutral" size="sm">
                Mín: {formatPrice(store.delivery_min_order)}
              </Badge>
            )}
          </div>
          ...
          {store.opening_hours && (
            <details className="mt-3 group">
              <summary className="text-label-md text-primary cursor-pointer hover:text-primary-container transition-colors list-none flex items-center gap-1">
                <svg
              ...
              <StoreHours
                ...
                className="mt-2 p-3 bg-surface-container rounded-radius-md"
              />
            </details>
          )}
        </div>
        ...
        {searchQuery ? (
          ...
          categories.map((cat) => (
            <MenuSection
              ...
              isActive={
                !searchQuery && cat.id === activeCategory
              }
            />
          ))
        )}
